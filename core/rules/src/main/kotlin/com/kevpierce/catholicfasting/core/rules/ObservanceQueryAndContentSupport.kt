@file:Suppress("LongLine", "MaxLineLength", "TooManyFunctions", "ktlint:standard:max-line-length")
    ...
    val fastingGallery: List<SacredImageryItem> =
        listOf(
            imagery(
                ...
                "HeroSacred",
                "Chapel Altar",
                "Keep your fasting quiet, prayerful, and rooted in worship.",
            ),
            imagery(
                "crucifix-altar",
                "SacredCrucifixAltar",
                "Crucifix Altar",
                "Bring sacrifice before Christ with humility.",
            ),
            imagery(
                "planning-journal",
                "SacredPlanningJournal",
                "Planning Journal",
                "Prepare discipline with peace and intention.",
            ),
            imagery(
                "eucharistic-support",
                "SacredChaliceVine",
                "Eucharistic Support",
                "Let support for discipline remain close to prayer.",
            ),
            ...
            imagery(
                ...
                "Prayer Journal",
                "Keep discipline joined to reflection and prayer.",
            ),
            imagery(
                "jerusalem-cross",
            ...
            imagery(
                ...
                "SacredAdventWreath",
                "Advent Wreath",
                "Wait with steady hope and prayerful preparation.",
            ),
            imagery(
                "paschal-candle",
                "SacredPaschalCandle",
                "Paschal Candle",
                "Let Easter light renew your discipline.",
            ),
            imagery(
                "lenten-path",
                "SacredLentenPath",
                "Lenten Path",
                "Walk the penitential road with patience and trust.",
            ),
            imagery(
                "almsgiving-table",
                "SacredAlmsgivingTable",
                "Almsgiving",
                "Join fasting to mercy for your neighbor.",
            ),
            imagery(
                "ember-days",
                "SacredEmberDays",
                "Ember Days",
                "Offer seasonal gratitude through prayer and restraint.",
            ),
            imagery(
                "purple-veil",
                "SacredPurpleVeil",
                "Penitential Veil",
                "Let quiet restraint make room for grace.",
            ),
            imagery(
                "friday-abstinence",
                "SacredFridayAbstinence",
                "Friday Abstinence",
                "Keep Friday penance close to the Cross.",
            ),
        )
}
